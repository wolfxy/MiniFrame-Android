...
public class MiniUIScrollView extends ScrollView implements MiniUIViewProtocol
{

	public MiniUIScrollView(Context context) {
		super(context);
	}
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public MiniUIScrollView setUIPosition(int x, int y) {
		setUIX(x);
		setUIY(y);
		return this;
	}

	public MiniUIScrollView setUIX(int x) {
		int w = getWidth();
		setLeft(x);
		setRight(x + w);
		return this;
	...
	public MiniUIScrollView setUIY(int y) {
		int h = getHeight();
		setTop(y);
		setBottom(y + h);
		return this;
	...
	public MiniUIScrollView setUIPosition(double x, double y) {
		setUIPosition(getParentWidthPercent(x), getParentHeightPercent(y));
		return this;
	}

	public MiniUIScrollView setUIX(double x) {
		setUIX(getParentWidthPercent(x));
		return this;
	}

	public MiniUIScrollView setUIY(double y) {
		setUIY(getParentHeightPercent(y));
		return this;
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public MiniUIScrollView setUICenter(int x, int y) {
		setUICenterX(x);
		setUICenterY(y);
		return this;
	}

	public MiniUIScrollView setUICenterX(int x) {
		setUIX(x - getWidth() / 2);
		return this;
	}

	public MiniUIScrollView setUICenterY(int y) {
		setUIY(y - getHeight() / 2);
		return this;
	}

	public MiniUIScrollView setUICenter(double x, double y) {
		setUICenterX(x);
		setUICenterY(y);
		return this;
	}

	public MiniUIScrollView setUICenterX(double x) {
		setUICenterX(getParentWidthPercent(x));
		return this;
	}

	public MiniUIScrollView setUICenterY(double y) {
	...
	public MiniUIScrollView setUIRight(int right) {
		int w = getWidth();
		setRight(right);
		setLeft(right - w);
		return this;
	...
	public MiniUIScrollView setUIBottom(int bottom) {
		int h = getHeight();
		setBottom(bottom);
		setTop(bottom - h);
		return this;
	...
	public MiniUIScrollView setUIRight(double right) {
		return setUIRight(getParentWidthPercent(right));
	}

	public MiniUIScrollView setUIBottom(double bottom) {
		return setUIBottom(getParentHeightPercent(bottom));
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public MiniUIScrollView setUISize(int width, int height) {
		setUIWidth(width);
		setUIHeight(height);
		return this;
	}

	public MiniUIScrollView setUIWidth(int width) {
		setRight(getLeft() + width);
		return this;
	}

	public MiniUIScrollView setUIHeight(int height) {
		setBottom(getTop() + height);
		return this;
	}

	public MiniUIScrollView setUISize(double width, double height) {
		setUIWidth(width);
		setUIHeight(height);
		return this;
	}

	public MiniUIScrollView setUIWidth(double width) {
		setUIWidth(getParentWidthPercent(width));
		return this;
	}

	public MiniUIScrollView setUIHeight(double height) {
		setUIHeight(getParentHeightPercent(height));
		return this;
	}

	public MiniUIScrollView setUISizeKeepCenter(int width, int height) {
		setUIWidthKeepCenter(width);
		setUIHeightKeepCenter(height);
		return this;
	}

	public MiniUIScrollView setUIWidthKeepCenter(int width) {
		int x = GetCenterX();
		setRight(getLeft() + width);
		setUICenterX(x);
		return this;
	...
	public MiniUIScrollView setUIHeightKeepCenter(int height) {
		int y = GetCenterY();
		setBottom(getTop() + height);
		setUICenterY(y);
		return this;
	...
	public MiniUIScrollView setUISizeKeepCenter(double width, double height) {
		setUIWidthKeepCenter(width);
		setUIHeightKeepCenter(height);
		return this;
	}

	public MiniUIScrollView setUIWidthKeepCenter(double width) {
		setUIWidthKeepCenter(getParentWidthPercent(width));
		return this;
	}

	public MiniUIScrollView setUIHeightKeepCenter(double height) {
		setUIHeightKeepCenter(getParentHeightPercent(height));
		return this;
	}

	public MiniUIScrollView ScaleSize(double scale) {
	...
	public MiniUIScrollView setUIDesignSizeScale(int width, int height) {
	...
	public MiniUIScrollView setUIDesignSizeScaleX(int width, int height) {
		float scale = (float) MiniUIScreen.width() / MiniUIScreen.width();
		setUISize((int) (width * scale), (int) (height * scale));
		return this;
	}

	public MiniUIScrollView setUIDesignSizeScaleY(int width, int height) {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public MiniUIScrollView setUIBackgroundColor(int color) {
		setBackgroundColor(color);
		return this;
	}

	public MiniUIScrollView setUITag(int tag) {
		setTag(tag);
		return this;
	}
	...
	public MiniUIScrollView setUIFillet(int width) {
	...
	public MiniUIScrollView setUIBorder(int cornerRadius, int color) {
		return setUIBorder(0, cornerRadius, color);
	}

	public MiniUIScrollView setUIBorder(int borderWidth, int cornerRadius, int color) {
		float[] outerRadii = new float[8];
		float[] innerRadii = new float[8];
		for (int i = 0; i < 8; i++) {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public MiniUIScrollView aid() {
		new MiniUIAid(this);
		return this;
	}

	public MiniUIScrollView CopyPositionFrom(View view) {
		setUIPosition(view.getLeft(), view.getTop());
		return this;
	}

	public MiniUIScrollView CopyCenterFrom(View view) {
		setUICenter(view.getLeft() + view.getWidth() / 2, view.getTop() + view.getHeight() / 2);
		return this;
	}

	public MiniUIScrollView CopySizeFrom(View view) {
		setUISize(view.getWidth(), view.getHeight());
		return this;
	}

	public MiniUIScrollView CopyFrameFrom(View view) {
