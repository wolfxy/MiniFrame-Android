...
public final class MiniLogger {
    ...
    private static Map<String, MiniLogger> sLoggerMap = new HashMap<String, MiniLogger>();
    ...
    public static MiniLogger get() {
        return get(DEFAULT_TAG);
    }

    public static MiniLogger get(String tag) {
        if (TextUtils.isEmpty(tag)) {
            throw new IllegalArgumentException("tag cannot be empty!");
        }
        MiniLogger log = sLoggerMap.get(tag);
        if (log == null) {
            log = new MiniLogger(tag);
    ...
    private static String buildMessage(String format, Object... args) {
        ...
        for (int i = 2; i < trace.length; i++) {
            ...
            if (!clazz.equals(MiniLogger.class)) {
    ...
    public static class MarkerLog {
        ...
        public MarkerLog(MiniLogger logger) {
            this.logger = logger;
        }
