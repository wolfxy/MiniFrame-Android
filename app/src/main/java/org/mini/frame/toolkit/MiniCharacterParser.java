 ...
 * 
 */
public class MiniCharacterParser {
	...
	private static MiniCharacterParser characterParser = new MiniCharacterParser();

	public static MiniCharacterParser getInstance() {
